...
function (_Component) {
  ...
  function DateTimeField() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function () {
      ...
      var calendarButtonClientRect = _this.refs.openCalendarButton.getBoundingClientRect();
      ...
      var scrollTop = window.pageYOffset !== undefined ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop; // let placePosition = (() => {
  ...
  _createClass(DateTimeField, [{
    ...
    value: function render() {
      ...
      }, this.props.inputProps)), _react.default.createElement("span", {
...
DateTimeField.propTypes = {
  ...
  direction: _propTypes.PropTypes.oneOf(["up", "bottom", "auto", undefined]),
  showToday: _propTypes.PropTypes.bool,
  viewMode: _propTypes.PropTypes.string,
