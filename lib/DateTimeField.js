...
var getViewDate = function getViewDate(props) {
  return (props.dateTime === "" ? (0, _moment.default)(undefined, undefined, true) : (0, _moment.default)(props.dateTime, props.format, true)).startOf("month");
};
...
function (_Component) {
  ...
  function DateTimeField() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      viewDate: getViewDate(_this.props),
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setSelectedDate", function (e) {
      ...
      if (target.className && !target.className.match(/disabled/g)) {
        ...
        _this.setState({
          ...
          this.closePicker();
          var changedDate = this.state.selectedDate;
          this.props.onChange(changedDate.format(this.props.format), changedDate.format(this.state.inputFormat));
          this.setState({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "subtractMinute", function () {
      _this.setState({
        ...
        var changedDate = _this.state.selectedDate;

        _this.props.onChange(changedDate.format(_this.props.format), changedDate.format(_this.state.inputFormat));

        _this.setState({
          inputValue: changedDate.format(_this.resolvePropsInputFormat())
        });
      });
    });
  ...
  _createClass(DateTimeField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, this.renderOverlay(), _react.default.createElement(_DateTimePicker.default, {
        ...
        className: "input-group date ".concat(this.size(), " ").concat(this.props.hasError ? "has-error" : ""),
