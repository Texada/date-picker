...
function (_Component) {
  ...
  function DateTimePickerDate() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DateTimePickerDate)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", viewModes[_this.props.viewMode] || viewModes[Object.keys(viewModes)[_this.props.viewMode]] || viewModes.days);
...
DateTimePickerDate.propTypes = {
  ...
  showPicker: _propTypes.default.bool.isRequired
};
